<div class="">
    ...
    {{-- ===================== SIDEBAR ===================== --}}
    <div class="bg-white border-r border-slate-200 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-64 lg:flex-col">
        <div class="flex grow flex-col overflow-y-auto px-4 pb-4">

            {{-- Logo area --}}
            <div class="flex h-16 shrink-0 items-center justify-center mt-2 mb-2">
                <div class="flex items-center gap-3 rounded-xl px-4 py-2 w-full justify-center">
                    <img src="{{ Storage::url('Logo/unpari.jpg') }}" alt="Logo" class="h-8 w-auto rounded-lg" />
                    <span class="text-slate-800 font-bold text-sm tracking-wide">SIBTA</span>
                </div>
            </div>
                ...
                <ul role="list" class="flex flex-1 flex-col gap-y-1">
                    ...
                    <li>
                        <a href="{{ $dashboardRoute }}" wire:navigate
                            class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium
                                   data-current:bg-blue-50 data-current:text-blue-700 text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-colors">
                    ...
                    {{-- ---- ADMIN menu group ---- --}}
                    @if ($isAdmin)
                        <p class="text-xs font-semibold uppercase tracking-widest text-slate-400 px-3 mt-4 mb-1">Admin</p>
                        ...
                        <li>
                            <a href="{{ route('admin.kaprodi') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('admin.kaprodi') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('admin.prodi') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('admin.prodi') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('jadwal-sidang') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('jadwal-sidang') || request()->routeIs('penentuan-penguji') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('pengelolaan-dokumen') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('pengelolaan-dokumen') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('laporan') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('laporan') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('admin.users') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('admin.users') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @if ($isDosen)
                        ...
                        <li>
                            <a href="{{ route('dosen.bimbingan') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('dosen.bimbingan') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                        ...
                        <li>
                            <a href="{{ route('dosen.bimbingan-online') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('dosen.bimbingan-online') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('dosen.kontrol-bimbingan') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('dosen.kontrol-bimbingan') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @if ($isKaprodi)
                        ...
                        <li>
                            <a href="{{ route('kaprodi.pengajuan-judul') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('kaprodi.pengajuan-judul') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="{{ route('kaprodi.laporan') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('kaprodi.laporan') || request()->routeIs('kaprodi.laporan.pdf') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @if ($isMahasiswa)
                        ...
                        <li>
                            <a href="{{ route('mahasiswa.bimbingan') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('mahasiswa.bimbingan') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                        ...
                        <li>
                            <a href="{{ route('mahasiswa.dokumen') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('mahasiswa.dokumen') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5A3.375 3.375 0 0010.125 2.25H6.75A2.25 2.25 0 004.5 4.5v15A2.25 2.25 0 006.75 21.75h10.5a2.25 2.25 0 002.25-2.25V14.25Z" />
                        ...
                        <li>
                            <a href="{{ route('mahasiswa.bimbingan-online') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('mahasiswa.bimbingan-online') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M8.625 9.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H15.75m-8.43 4.5a18.687 18.687 0 0 1-1.281 3.527.75.75 0 0 0 1.28.798l1.896-2.845a9 9 0 1 0-1.895-1.48Z" />
                        ...
                        <li>
                            <a href="{{ route('mahasiswa.pengajuan-sidang') }}" wire:navigate
                                class="group flex items-center gap-x-3 rounded-xl px-3 py-2 text-sm font-medium transition-colors
                                       {{ request()->routeIs('mahasiswa.pengajuan-sidang') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @if ($profilePhoto)
                                    <img src="{{ Storage::url($profilePhoto) }}" alt=""
                                        class="size-9 rounded-full object-cover ring-2 ring-slate-200 shrink-0" />
                                @else
                                    <div
                                        class="flex size-9 shrink-0 items-center justify-center rounded-full bg-blue-100 text-xs font-semibold text-blue-700 ring-2 ring-slate-200">
                                        {{ Auth::user()->initials() }}
                                    </div>
                                @endif
                                ...
                                {{-- Logout --}}
                                <livewire:auth.logout class="shrink-0">
                                    <span class="cursor-pointer text-slate-400 hover:text-rose-500 transition-colors"
                                        title="Keluar">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="lg:pl-64">
        ...
        {{-- ---- TOPBAR ---- --}}
        <div
            class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-slate-200 bg-white px-4 sm:gap-x-6 sm:px-6 lg:px-8">

            {{-- Mobile hamburger --}}
            <button type="button" command="show-modal" commandfor="sidebar"
                class="-m-2.5 p-2.5 text-slate-600 hover:text-slate-900 lg:hidden">
            ...
            {{-- Mobile separator --}}
            <div aria-hidden="true" class="h-6 w-px bg-slate-200 lg:hidden"></div>
                ...
                <div class="flex items-center gap-x-4 lg:gap-x-6">
                    ...
                    <el-dropdown class="relative">
                        <button
                            ...
                            @if ($profilePhoto)
                                <img src="{{ Storage::url($profilePhoto) }}" alt=""
                                    class="size-9 rounded-full object-cover ring-2 ring-slate-100" />
                            @else
                                <div
                                    class="flex size-9 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 text-xs font-semibold text-blue-700 ring-2 ring-slate-100">
                                    {{ Auth::user()->initials() }}
                                </div>
                            @endif
                        ...
                        <el-menu anchor="bottom end" popover
                            ...
                            <div
                                class="rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 p-4 text-white">
